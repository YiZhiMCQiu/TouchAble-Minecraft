...
public final class Main {
    ...
    public static void main(String[] args) throws Throwable {
        ...
        String config = "X:\\Mods\\[可触控のMC]touch-1.21-fabric\\.gradle\\loom-cache\\launch.cfg";
        if (main == null) {
            System.err.println("error: missing fabric.dli.main property, can't launch");
            System.exit(1);
        } else if (env != null && config != null) {
            Path configFile;
            if (Files.isRegularFile(configFile = Paths.get(decodeEscaped(config)), new LinkOption[0]) && Files.isReadable(configFile)) {
                ...
                try {
                    ...
                    args = newArgs;
                    Iterator var8 = extraProperties.entrySet().iterator();
